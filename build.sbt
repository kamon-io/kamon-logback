...
val kamonAgentExtension   = "io.kamon"        %%  "agent-scala-extension"   % "0.0.6-experimental"
...
lazy val root = (project in file("."))
  ...
  .settings(javaAgents += "io.kamon" % "kamon-agent" % "0.0.6-experimental" % "compile;runtime;test")
  .settings(
    libraryDependencies ++=
